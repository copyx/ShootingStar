/*	var quest_ori = {
	...
	function insertQuest() {
		...
		$.ajax({
	         type : "post",
	         url : "http://192.168.0.25:8080/Soscon/User/insertQuest.json",
	         dataType:"text", 
	...
	function updateQuest() {
		...
		$.ajax({
			type : "post",
			url : "http://192.168.0.25:8080/Soscon/User/updateQuest.json",
			dataType:"text", 
			contentType:"application/json",
			data : sendData,
			success : function(data){
	...
	function deleteQuest() {
		$.ajax({
			type : "get",
			url : "http://192.168.0.25:8080/Soscon/User/deleteQuest",
			dataType:"text", 
	...
	function selectQuestByAreaNCity() {
		$.ajax({
			type : "get",
			url : "http://192.168.0.25:8080/Soscon/User/selectQuestByAreaNCity",
			dataType:"json", 
	...
	function selectQuestByCategory() {
		$.ajax({
			type : "get",
			url : "http://192.168.0.25:8080/Soscon/User/selectQuestByCategory",
	        dataType:"json", 
	...
	function selectAllQuest() {
		$.ajax({
			type : "get",
			url : "http://192.168.0.25:8080/Soscon/User/selectAllQuest",
			dataType:"json", 
			success : function(data){
				console.log(data);
			},
